...
MainGame.MainMenu.prototype = {
	...
	initMenu: function() {
		if (this.getDomain(document.domain) == "github.com" || this.getDomain(document.domain) == "github.io" || this.getDomain(document.domain) == "repl.co" || this.getDomain(document.domain) == "cmatgame.local" || this.getDomain(document.domain) == "localhost");
		else {
			var t = game.add.text(MainGame.midX, 175, "site-lock", MainGame.style);
			t.anchor.setTo(.5);
			return
		}
