    ...
    const HANDLER_CLASS = class RuntimeDOMHandler extends self.DOMHandler {
        constructor(iRuntime) {
            ...
            iRuntime.AddRuntimeComponentMessageHandler("runtime",
                "set-target-orientation", e => this._OnSetTargetOrientation(e));
            ...
            iRuntime.AddRuntimeComponentMessageHandler("runtime",
                "debug-highlight", e => this._OnDebugHighlight(e));
...
(() => {
    ...
    class DomHandler extends DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddDOMElementMessageHandler('INIT_METRICA', (_, {
                metricaId
            }) => {
            ...
            this.AddDOMElementMessageHandler('YSDK_PAYMENTS_PURCHASE', (_, {
                purchaseId
            }) => this.payments.purchase(purchaseId));
            this.AddDOMElementMessageHandler('YSDK_PAYMENTS_CONSUME_PURCHASE', (_, {
                purchaseToken
            }) => this.payments.consumePurchase(purchaseToken));
            ...
            // ADS
            this.AddDOMElementMessageHandler('YSDK_ADS_SHOW_FULLSCREEN', () => this.ysdk.adv.showFullscreenAdv({
                callbacks: {}
            }));
            ...
            // METRICA
            this.AddDOMElementMessageHandler('YSDK_METRICA_REACH_GOAL', (_, {
                target
            }) => ym(this.metricaId, 'reachGoal', target));

            // RTB BANNERS
            this.AddDOMElementMessageHandler('YSDK_RTB_CREATE_BANNER', (_, {
                id,
                x,
                y,
                width,
            ...
            this.AddDOMElementMessageHandler('YSDK_RTB_CREATE_STICKY_BANNER', (_, {
                id,
                position,
                width,
                height,
            ...
            this.AddDOMElementMessageHandler('YSDK_RTB_DESTROY_BANNER', (_, {
                id
            }) => this.destroyBanner(id));
            this.AddDOMElementMessageHandler('YSDK_RTB_DISPLAY_BANNER', (_, {
                id
            }) => {
                this.rtbRenderBanner(id);
            });
            this.AddDOMElementMessageHandler('YSDK_RTB_REFRESH_BANNER', (_, {
                id
            }) => {
                this.destroyBanner(id);
                this.rtbRenderBanner(id);
            ...
            return new Promise((resolve) => {
                const initSDK = async () => {
                    this.ysdk = await YaGames.init({
                        screen,
                        adv: {
                            onAdvClose: (wasShown) => this.PostToRuntimeElement('SDK_ADS_CLOSED', ELEMENT_ID, {
                                wasShown
                            })
                        },
                    });
        ...
        rtbRenderBanner(id) {
            ...
            Ya.Context.AdvManager.render({
                ...
                renderTo: id,
                async: true,
                onRender: () => this.PostToRuntimeElement('SDK_RTB_RENDER', ELEMENT_ID, {
                    id
                })
            });
        }
