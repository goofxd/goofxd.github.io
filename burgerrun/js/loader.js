var LoaderState = {
	preload: function() {
		...
		game.load.image('bricks103', 'assets/img/bricks103.png');
		game.load.image('bricks104', 'assets/img/bricks104.png');
		...
		game.load.image('lbg3', 'assets/img/lbg3.gif');
		game.load.image('lbg4', 'assets/img/lbg4.gif');
		game.load.image('lbg7', 'assets/img/lbg7.gif');
		...
		game.load.image('bbTitle', 'assets/img/bbTitle.png');
		game.load.image('logoBR', 'assets/img/logoBR.png');
		...
		game.load.spritesheet('tuts', 'assets/img/tuts.gif', 180, 70);
		...
		game.load.audio('fxFall', 'assets/sfx/fxFall.wav');
		...
		game.load.audio('fxDD', 'assets/sfx/fxDD.wav');
		...
		game.load.image('pauseBG', 'assets/img/pauseBG.png');
	},
	create: function() {
		world.lode.destroy();
