    ...
    _createSegmentFactories(context) {
        ...
        for (let loop = 0; loop < 6; loop++) {
            ...
            if (loop === 3) {
                ...
                for (let i = 0; i < 2; i++) {
                    [
                        [10, 0.2, 'BridgeCracks1'],
                        [-20, 0.1, 'Bridge'],
                        [-10, -0.3, 'BridgeCracks2'],
                        [-5, 0.3, 'BridgeCracks1'],
                        [10, 0.2, 'Bridge'],
                        [20, -0.2, 'BridgeCracks3']
                    ].forEach(p =>
                        create(() => this._road.createSegment(p[2], d2r(p[0]), p[1], {})));
                }
                ...
                create(() => this._road.createSegment('Forest', d2r(30), 0, {}, 1.12, 1, -0.1));
            }
            ...
            if (loop === 4) {
                ...
                create(() => this._road.createSegment('Forest', d2r(30), -4, {}, 1, 1.3));
                ...
                create(() => {
                    this._checkpointSegmentIndex = this._road.createSegment('Tunnel', d2r(0), -0.3, {}).index;
                });
                create(() => {
                ...
                for (let i = 0; i < 2; i++) {
                    [
                        [30, -0.5, 'Tunnel'],
                        [-30, -0.5, 'TunnelBarricade1'],
                        [-20, -0.5, 'Tunnel'],
                        [-20, -0.5, 'Tunnel'],
                        [30, -0.5, 'TunnelBarricade2'],
                        [-30, -0.5, 'Tunnel']
                    ].forEach((p, j) =>
                        create(() => this._road.createSegment(p[2], d2r(p[0]), p[1], {
                            useLight: j % 3 !== 0,
            ...
            // Tuonela
            if (loop === 5) {
                create(() => this._road.createSegment('Tuonela', d2r(0), 0, {}, 0.7));
                ...
                for (let i = 0; i < 10; i++) {
                    create(() => this._road.createSegment('Tuonela', d2r(48), -3, {}, 1 - i * 0.04, 1 - (i + 1) * 0.04));
                }
                create(() => this._road.createSegment('Tuonela', d2r(10), -2, {}, 0.6, 0.5));
                create(() => this._road.createSegment('Tuonela', d2r(5), -1, {}, 0.5, 0.4));
                create(() => this._road.createSegment('Tuonela', d2r(2), -0., {}, 0.4, 0.6));
